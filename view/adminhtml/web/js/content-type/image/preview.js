...
define(["Magento_PageBuilder/js/events", "Magento_PageBuilder/js/content-type-menu/hide-show-option", "Magento_PageBuilder/js/uploader", "Magento_PageBuilder/js/content-type/preview"], function (_events, _hideShowOption, _uploader, _preview) {
    ...
    var Preview = /*#__PURE__*/function (_preview2) {
        ...
        _proto.getViewportImageData = function getViewportImageData() {
            var desktopImageData = this.data.desktop_image_new;
            var mobileImageData = this.data.mobile_image_new;
            console.log(this.data.desktop_image_new, 'desk image')
            console.log(this.data.mobile_image_new, 'mobile image')
            return this.viewport() === "mobile" && typeof mobileImageData !== "undefined" ? mobileImageData : desktopImageData;
        }

        _proto.getViewportImageAspectRatioData = function getViewportImageAspectRatioData() {
            var desktopImageAspectRatioData = this.data.main;
            var mobileImageAspectRatioData = this.data.main_mobile;
            console.log(this.viewport(), 'the viewport')
            return this.viewport() === "mobile" && typeof mobileImageAspectRatioData !== "undefined" ? mobileImageAspectRatioData : desktopImageAspectRatioData;
        }
